  ...
  return (
    <div className="flex-1 p-4 md:p-8">
      <header className="flex items-center gap-4 mb-8">
        ...
        <h1 className="text-3xl font-bold tracking-tight">About FloatChat</h1>
      </header>
      ...
      <main className="space-y-8">
        <Card>
          ...
          <CardContent className="space-y-4 text-muted-foreground">
            <p>
              Argo is a global array of nearly 4,000 free-drifting profiling floats that measures the temperature and salinity of the upper 2000 m of the ocean. This allows, for the first, continuous monitoring of the temperature, salinity, and velocity of the upper ocean, with all data being relayed and made publicly available within hours after collection.
            </p>
            <p>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              The FloatChat Project
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-4 text-muted-foreground">
            <p>
              FloatChat is a full-stack web application designed to make ARGO float data more accessible and interactive. It leverages the power of Artificial Intelligence to allow users to query the vast ARGO dataset using natural language.
            </p>
            <p>
